...
INSERT INTO client (id, nom, prenom, adresse, date_de_naissance,private_id) VALUES ('rthh6rf4h6r4h6r4h64df6hn4gfd6h4fd','Michel','Michel','75  place Stanislas 54000 Nancy', '15-02-1995','f4b3231e');
INSERT INTO client (id, nom, prenom, adresse, date_de_naissance,private_id) VALUES ('kuy4kg6y4k6g4k6g4hk6j4hk64gh6k4g6','Jean','Pierre','25  Square de la Couronne 75001 Paris', '15-10-1985','f3b3f31e');
INSERT INTO client (id, nom, prenom, adresse, date_de_naissance,private_id) VALUES ('bf435nf354gn4fvn64f6h4h6gnfh34n5f','Clément','Pala','46  place Stanislas 44100 Nantes', '15-01-1999','f4b3f41e');
INSERT INTO client (id, nom, prenom, adresse, date_de_naissance,private_id) VALUES ('d3f4h35df43jh1gbn3f4gnjhf32hn1f5n','Vandal','Dominique','49  rue Banaudon 69008 Lyon', '15-01-1999','f4b3f319');


INSERT INTO demande (id, client, revenus_sur_trois_annees, montant_credit, duree_en_mois, etat_demande,private_id) VALUES ('ff8081816e9e21ef016e9e532dbd80000','f4b3231e', 100000, 20000, 18,1,'h65g4edt65h4654h');
INSERT INTO demande (id, client, revenus_sur_trois_annees, montant_credit, duree_en_mois, etat_demande,private_id) VALUES ('8a80cb816f24c0ea016f24d97157000f1','f3b3f31e', 35000, 20000, 18,3,'634dh56h4d65h46');
INSERT INTO demande (id, client, revenus_sur_trois_annees, montant_credit, duree_en_mois, etat_demande,private_id) VALUES ('sgjsognonsoe21ef016e9e5gsdpginsd0','f4b3f41e', 15000, 20000, 18,4,'gd4f65gh4df64gh6');
INSERT INTO demande (id, client, revenus_sur_trois_annees, montant_credit, duree_en_mois, etat_demande,private_id) VALUES ('7gd4bf6fn46fd4n6d84n6d4n64d6n4d64','f4b3f319', 150000, 300000, 32,5,'htrhrhsfdhgsdfgh');
