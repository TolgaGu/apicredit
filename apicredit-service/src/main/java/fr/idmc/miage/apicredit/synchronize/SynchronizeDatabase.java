...
public class SynchronizeDatabase {
    ...
    public static void syncDemande(Demande demande) {
        ...
        HttpResponse<String> response = Unirest.post("http://localhost:8081/demandes")
    ...
    public static void syncUpdateDemande(Demande demande) {

        HttpResponse<String> response = Unirest.put("http://localhost:8081/demandes/"+demande.getPrivate_id())
                .header("Content-Type", "application/json")
                ...
                .body("{\n\t \"client\":\"" + demande.getClient() + "\"," +
                        ...
                        "\"duree_en_mois\":\"" + demande.getDuree_en_mois() +"\"}")
                .asString();
        LOGGER.log(Level.INFO,"Demande update synchronized : "+response.getStatus());

    }

    public static void syncClient(InputClient client){
        HttpResponse<String> response = Unirest.post("http://localhost:8081/clients")
                .header("Content-Type", "application/json")
